...
<header>
    <nav id="headNav" class="navbar navbar-default ms-nav-anim navbar-fixed-top" role="navigation">
       ...
       <div class="navbar-header">
          ...
          <a class="navbar-brand ms-logo" style='padding-top: 35px; padding-left: 25px;'>
             EmprestAê
             <!--<img alt="sphinx logo" title="sphinx" class="img-responsive" src="mdl/img/sphinx/logo.png">-->
          </a>
       </div>
